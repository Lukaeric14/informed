...
const VendorCard = ({ name, primary_category, description, logo_url, created_at, openPopup }) => { // Added openPopup prop
  return (
        ...
        <div className="w-full justify-start items-center gap-[9px] inline-flex" style={{ marginTop: 10 }}>
            ...
            <div className="w-full flex justify-between">
                ...
                <div className="flex flex-col">
                    <button onClick={openPopup} style={{ backgroundColor: '#017F40', color: 'white', padding: '7px 30px', borderRadius: '5px', marginBottom: '4px', fontSize: '12px' }}>Contact Anonymously</button>
