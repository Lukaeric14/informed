...
import ContactPopup from './buildvendorlistPopup'; // Import the ContactPopup component
    ...
    <div>
      {user ? (
        ...
        <div style={{width: '100%', height: '100%', padding: 10, background: 'white', borderRadius: 15, overflow: 'hidden', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 15, display: 'inline-flex'}}>
          ...
          <button onClick={handleOpenContactPopup} style={{paddingLeft: 20, paddingRight: 20, paddingTop: 9, paddingBottom: 9, background: '#F3F3F3', borderRadius: 5, overflow: 'hidden', justifyContent: 'center', alignItems: 'center', gap: 20, display: 'flex', flexDirection: 'column'}}>
